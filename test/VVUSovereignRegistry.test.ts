...
import * as hardhatNS from "hardhat";
// Use namespace import + destructure to avoid ESM/CJS interop issue where
// `import { ethers } from "hardhat"` fails with "does not provide an export named 'ethers'"
// when bun/ESM resolves the hardhat module.
const { ethers } = hardhatNS as any;
