// VVU Trust Runtime — production landing layout.
// Self-contained HTML document (styles + client script) rendered in an
// isolated iframe by app/page.tsx. Authored without backticks or ${} so it
// is safe to embed as a template literal.
export const trustRuntimeHtml = `<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
