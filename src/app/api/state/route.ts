 ...
 * GET /api/state
 *
 * Returns the full state of the IVE: all claims with their evidence,
 * authorization records, circuit breaker events, and N_ind computations.
 * Also returns a system-level summary.
 */
