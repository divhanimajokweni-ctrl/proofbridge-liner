/**
 * VVU IVE — World Container (ARCHIVED)
 * =====================================
 *
 * This is the "Build / Study / Data / Finance" rooms shell that was
 * briefly placed at the `/` route. It was moved here because the user
 * explicitly requires the SYNTHESIZED SPATIAL INTELLIGENCE hero to be
 * the first thing visitors see at `/`.
 *
 * This component is preserved here so the work is not lost. To surface
 * it at a different route (e.g. /ive), copy this file to
 * src/app/ive/page.tsx and remove this header comment.
 *
 * Original imports:
 ...
 * (all exist on disk under src/components/ive/rooms/)
 */
'use client';
...
export default function VVUWorldContainer() {
  ...
  return (
    <div className="kernel-theme min-h-screen flex flex-col k-grid-bg">
      ...
      <main className="flex-1">
        {/* Dynamic room import — left as comment to avoid breaking
            the build when this file is archived. */}
        {/* room === 'build' && <BuildRoom /> */}
        {/* room === 'study' && <StudyRoom /> */}
        {/* room === 'data' && <DataRoom /> */}
        {/* room === 'finance' && <FinanceRoom /> */}
        <div className="p-8 text-center text-[var(--k-dim)]">
          <p className="text-xs uppercase tracking-widest">
            [Archived World Container — {currentRoom.label} Room selected]
          </p>
          <p className="mt-2 text-[10px] opacity-60">
            To activate, copy this file to src/app/ive/page.tsx and restore
            the room imports listed in the header comment.
          </p>
        </div>
      </main>
