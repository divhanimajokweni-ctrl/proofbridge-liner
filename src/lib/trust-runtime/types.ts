// ============================================================================
// Epistemic Runtime — Trust Runtime Canonical Event Model
// ============================================================================
...
// Adapted from proofbridge-liner: uses numeric timestamps from injected
// clock instead of Date.now(). No Math.random() — uses injected entropy.
// ============================================================================
...
export type RuntimeEvent = {
  ...
  version: number;
  /** When the event was created (numeric timestamp from injected clock). */
  timestamp: number;
