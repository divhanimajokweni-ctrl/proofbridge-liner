...
interface EvidenceItem {
  ...
  // Accept both Date (canonical eis type) and string (JSON-serialized form).
  // The local pipeline often holds items deserialized from JSON, where Date
  // becomes string. The canonical eis/types.EvidenceItem uses Date.
