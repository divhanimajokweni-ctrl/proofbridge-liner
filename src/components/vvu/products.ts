...
export const PRODUCTS: ProductMeta[] = [
  ...
  },
  {
    ...
    tag: "HBK",
    icon: BrainCircuit,
    mission: "Hydro Bayesian Kernel. Reproducible MCMC derivation logs signed with Ed25519. Brier Score > 0.02 triggers a TRIP verdict (HF-005).",
    tagline: "MCMC · Brier ≤ 0.02 · Ed25519 derivation",
    accent: "#ff2e5f",
    shortcut: 6,
    signals: [
      { label: "Derivations", value: "—", hint: "Pending telemetry" },
      { label: "Brier Score", value: "—", hint: "HF-005 threshold 0.02" },
