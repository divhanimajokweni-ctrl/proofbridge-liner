...
export function SignInForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => { e.preventDefault(); setError(""); setLoading(true); try { const r = await signIn("credentials", { email, password, redirect: false }); if (r?.error) setError("Invalid email or password"); } catch { setError("Error."); } finally { setLoading(false); } };
  return (
